        ...
        <div className="max-w-wide mx-auto px-5 md:px-10 flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-4 relative z-[60]">
            ...
            <Link
              ...
              className={`relative w-10 h-10 flex items-center justify-center text-neutral-300 hover:text-white transition-all duration-200 ${menuOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
              aria-label="Cart"
            >
              ...
              {totalItems > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-brand-red text-white text-[9px] font-bold w-4 h-4 flex items-center justify-center leading-none">
                  {totalItems}
                </span>
              )}
            </Link>
