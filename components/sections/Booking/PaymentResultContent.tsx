...
const messages = {
  en: {
    ...
    retry: 'Book Again',
    home: 'Back to Home',
    waSuccess: `ONEX BOOKING - Hi, I've just paid the RM10 deposit for a door-to-door inspection. Please confirm my appointment. Thank you!`,
  ...
  ms: {
    ...
    waSuccess: `ONEX BOOKING - Hi, saya telah membayar deposit RM10 untuk tempahan pemeriksaan pintu ke pintu. Sila sahkan temujanji saya. Terima kasih!`,
  ...
  zh: {
    ...
    retry: '重新预约',
    home: '返回首页',
    waSuccess: `ONEX BOOKING - 您好，我已支付RM10押金预约上门检测服务。请确认我的预约。谢谢！`,
      ...
      .then(data => {
        if (data.status === 'confirmed' || data.status === 'completed') {
          ...
          const purchaseData = {
            ...
            items: [{ item_name: 'Door-to-Door Inspection Deposit', price: data.amount || 10, quantity: 1 }],
          }
