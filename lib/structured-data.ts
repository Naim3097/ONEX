...
export function generateLocalBusinessJsonLd() {
  return {
    ...
    image: [
      ...
      'https://www.onextransmission.com/images/Gallery/Toyota%20GT86.jpeg',
    ],
    address: {
      '@type': 'PostalAddress',
      streetAddress:
    ...
    keywords:
      'gearbox specialist Shah Alam, CVT transmission repair Malaysia, automatic gearbox overhaul Selangor, transmission workshop Klang Valley, best gearbox workshop Malaysia, trusted transmission repair, gearbox specialist Penang, gearbox workshop Simpang Ampat, CVT repair Penang, gearbox workshop Bukit Mertajam, transmission repair Butterworth, gearbox Bukit Tambun, gearbox Juru Perai, transmission workshop Seberang Perai, gearbox specialist Kulim, transmission repair Sungai Petani',
    sameAs: [
